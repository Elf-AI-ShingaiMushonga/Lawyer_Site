...
def upgrade() -> None:
    if not _has_table("tender_opportunity"):
        op.create_table(
            ...
            sa.Column("briefing_required", sa.Boolean(), nullable=False, server_default=sa.false()),
            ...
            sa.Column("cidb_required", sa.Boolean(), nullable=False, server_default=sa.false()),
            sa.Column("cidb_grading", sa.String(length=40), nullable=True),
            sa.Column("local_content_required", sa.Boolean(), nullable=False, server_default=sa.false()),
